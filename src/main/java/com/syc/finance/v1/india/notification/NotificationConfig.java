package com.syc.finance.v1.india.notification;
...
import static com.syc.finance.v1.india.constants.AccountDetailsConstants.TWILIO_PHONE_NUMBER;
...
public class NotificationConfig {
    ...
    public void sendSMS(String messageBody) {
        PhoneNumber recipientNumber = new com.twilio.type.PhoneNumber("+919977177134");
